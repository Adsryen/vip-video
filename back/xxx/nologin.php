...
<head>
	...
	* { margin:0; padding:0; }
	...
	.nologin { width:600px; margin:0 auto 0; background:#fff; position:fixed; top:50%; right:0; left:0; }
	.loginhead { padding:30px 0; color:#fff; text-align:center; background:#305e8d; }
	...
	.loginuser label { font-size:14px; color:#305e8d; font-weight:bold; }
	.loginuser input { float:right; padding:0 20px; font-size:14px; color:#fff; text-align:center; line-height:30px; border:0; border-radius:2px; cursor:pointer; background:#305e8d; }
