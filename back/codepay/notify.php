...
{ //业务处理例子 返回一些字符串
    ...
    if ($rs && $stmt->affected_rows >= 1) { //插入成功 是首次通知 可以执行业务
        ...
        $x1 = "%**#".$price;
        if(strpos($x1,"1") > 0){         //if(strpos($x1,"1") > 0){ 中的"1" 为7天卡价格
        $x1 = "7" ;
        ...
        if(strpos($x1,"3") > 0){         //if(strpos($x1,"1") > 0){ 中的"18" 为30天卡价格
        $x1 = "30" ;
        $x1 = $x1 * 86400 ;//1表示比率为1:1  100则表示1元可充值100分;
        $sql = "update `" . DB_USERTABLE . "` set " . DB_USERMONEY . "=" . DB_USERMONEY . "+{$x1} where " . DB_USERNAME . "=?";
        $fx1 = "1" ; //分销获得金额
        ...
        if(strpos($x1,"28") > 0){         //if(strpos($x1,"1") > 0){ 中的"18" 为90天卡价格
        $x1 = "90" ;
        $x1 = $x1 * 86400 ;//1表示比率为1:1  100则表示1元可充值100分;
        $sql = "update `" . DB_USERTABLE . "` set " . DB_USERMONEY . "=" . DB_USERMONEY . "+{$x1} where " . DB_USERNAME . "=?";
        $fx1 = "1" ; //分销获得金额
        ...
        if(strpos($x1,"38") > 0){         //if(strpos($x1,"1") > 0){ 中的"38" 为180天卡价格
        $x1 = "180" ;
        $x1 = $x1 * 86400 ;//1表示比率为1:1  100则表示1元可充值100分;
        $sql = "update `" . DB_USERTABLE . "` set " . DB_USERMONEY . "=" . DB_USERMONEY . "+{$x1} where " . DB_USERNAME . "=?";
        $fx1 = "1" ; //分销获得金额
        ...
        if(strpos($x1,"48") > 0){         //if(strpos($x1,"1") > 0){ 中的"48" 为360天卡价格
        $x1 = "360" ;
        $x1 = $x1 * 86400 ;//1表示比率为1:1  100则表示1元可充值100分;
        $sql = "update `" . DB_USERTABLE . "` set " . DB_USERMONEY . "=" . DB_USERMONEY . "+{$x1} where " . DB_USERNAME . "=?";
        $fx1 = "1" ; //分销获得金额
        ...
        if(strpos($x1,"58") > 0){         //if(strpos($x1,"1") > 0){ 中的"58" 为666天卡价格
        $x1 = "666" ;
        $x1 = $x1 * 86400 ;//1表示比率为1:1  100则表示1元可充值100分;
        $sql = "update `" . DB_USERTABLE . "` set " . DB_USERMONEY . "=" . DB_USERMONEY . "+{$x1} where " . DB_USERNAME . "=?";
        $fx1 = "1" ; //分销获得金额
