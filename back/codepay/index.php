    ...
    <section class="clearfix g-member">
        <div class="g-Recharge">
            <ul id="ulOption">
                ...
                <li money="0.5" param="7"><a href="javascript:;"class="z-sel">7天<s></s></a></li><!--class="z-sel" 表示默认选中0.5元-->
                <li money="2" param="30"><a href="javascript:;">30天<s></s></a></li>
                <li money="5" param="90"><a href="javascript:;" >90天<s></s></a></li> 
                <li money="10" param="180"><a href="javascript:;">180天<s></s></a></li>
                <li money="15"  param="360"><a href="javascript:;">360天<s></s></a></li>
                <li money="30" param="666"><a href="javascript:;">999天<s></s></a></li>
            </ul>
        </div>
            ...
            <article class="clearfix mt10 m-round g-pay-ment g-bank-ct">
                <ul id="ulBankList">
                    <li class="gray6" style="width: 100%;padding: 5px 0px 0px 10px;height: 50px;">您选择充值：<label
                            ...
                            <input type="text" name="price" id="price" placeholder="如：50" value="28"
