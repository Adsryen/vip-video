...
$mchid = '1510333621';          //微信支付商户号 PartnerID 通过微信支付商户资料审核后邮件发送
$appid = 'wx7447fd3333e4f60d';  //公众号APPID 通过微信支付商户资料审核后邮件发送
$apiKey = 'woaieshenghuo1234567890woaieshen';   //https://pay.weixin.qq.com 帐户设置-安全设置-API安全-API密钥-设置API密钥
$wxPay = new WxpayService($mchid,$appid,$apiKey);
$outTradeNo = uniqid();     //你自己的商品订单号
$payAmount = 0.01;          //付款金额，单位:元
$orderName = 'pay_test';    //订单标题
