<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"/www/wwwroot/yy.idc66.xyz/applications/index/view/vip/apptc.html";i:1552314480;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form layui-card-body"  method="post" action="">
					 <div class="layui-form-item">
					  ...
					  <div class="layui-form-item">
               		...
               		<div class="layui-form-item">
							<label class="layui-form-label">首页搜索链接</label>
						    <div class="layui-input-block">
						      <input type="text" name="ssurl"  value="<?php echo $list['ssurl']; ?>" lay-verify="required" placeholder="请输入地址" autocomplete="off" class="layui-input">
						    </div>
					  </div>
