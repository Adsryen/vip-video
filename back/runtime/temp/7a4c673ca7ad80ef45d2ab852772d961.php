<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/www/wwwroot/yy.idc66.xyz/applications/index/view/user/index.html";i:1551816900;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">	
                    			 <div class="caption font-green bold">
                                        <span class="am-icon-code"></span> 合伙人管理
                              </div>
...
<!--  <?php if(session('power')=='0'){?>
                        ...
                        <div class="btn-group dropdown-btn-group pull-right">
                            ...
                            <a href="javascript:;" onclick="money('0','')" class=btn-single">
                              ...
                              <a href="javascript:;" onclick="tiquhhr()" class=btn-single">
                                <button class="btn btn-red" ><i class="el-basket-circled"></i> 提取合伙人资料
                                </button>
                            </a>
...
<script>
    ...
    function tiquhhr() {
        ...
        window.open('/index/user/tiquhhr.html');
    }
