<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/www/wwwroot/959495.xyz/applications/index/view/banner/add.html";i:1551816900;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1"  method="post" action="<?php echo url('banner/create'); ?>" enctype="multipart/form-data" class="validate">
			...
			<!--<div class="form-group">
                ...
                <input type="text" class="form-control" name="picurl"  placeholder="" />
            </div>-->
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label" style="color:ff0000" > 分类 ( 此项必选 ）</label>
                <br>
