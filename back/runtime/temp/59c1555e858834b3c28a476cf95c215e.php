<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"/www/wwwroot/959495.xyz/applications/index/view/dao/copy.html";i:1551816900;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
/*var a=document.getElementById("Copy").innerText;
      alert( a );*/
        layer.msg('激活码复制成功');
    }
	...
	function copy(message) {
	        ...
	        var input = document.createElement("input");
                ...
                <p class="flex-two"><span class="fq-shareapp-code"  id="Copy"   onClick="copy('<?php echo $_GET['jihuoma']; ?>')"><?php echo $_GET['jihuoma']; ?></span>
                </p>
                  ...
                  <ul class="tpl-task-list">
                                    <li>
                                        ...
                                        <div class="task-title">
                                                    <span class="task-bell"> <i class="am-icon-bullhorn"></i></span>   <span class="task-title-sp"> 点击激活码即可快速复制 </span>
