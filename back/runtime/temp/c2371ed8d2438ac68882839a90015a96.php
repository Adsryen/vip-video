<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"/www/wwwroot/yy.idc66.xyz/application/index/view/mn/index.html";i:1551816900;}*/ ?>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk"
                    ...
                    <div class="btn-toolbar">
                        <div class="btn-group focus-btn-group">
                            <a href="http://www.zuidazy.net/?m=vod-type-id-16.html">
                    ...
                    <div class="btn-toolbar">
                        <div class="btn-group focus-btn-group">
                            <a href="http://okzyw.com/?m=vod-type-id-22.html">
                                <button class="layui-btn layui-btn-blue"><i class="el-pencil"></i> 资源采集②</button>
                            </a>
                        </div>    
                    ...
                    <div class="btn-toolbar">
                        <div class="btn-group focus-btn-group">
                            <a href="http://www.zuidazy.net/?m=vod-type-id-17.html">
                                <button class="layui-btn layui-btn-blue"><i class="el-pencil"></i> 资源采集③</button>
                            </a>
                        </div>                         
                    ...
                    <table cellspacing="0" class="layui-table">
                        ...
                        <tr>
                           ...
                           <th style=" text-align: center;">
                               ...
                               <a href="<?php echo url('mn/update',['id'=>$vo['id']]); ?>" title="修改"  class="layui-btn layui-btn-xs" >修改</a>
                               &nbsp;
                               <a href="<?php echo url('mn/del',['id'=>$vo['id']]); ?>" title="删除" class="layui-btn layui-btn-xs layui-btn-warm">删除</a></th>
