<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"/www/wwwroot/959495.xyz/applications/index/view/common/common.html";i:1556074374;}*/ ?>
<?php
...
<head>
    ...
    <link rel="stylesheet" href="/public/static/assets2/css/layui.css">
    <link rel="stylesheet" href="/public/static/assets2/css/admin.css">
  <link rel="icon" href="/public/static/adminlog/images/favicon.ico" >
        ...
        <div class="layui-side-scroll">
            ...
            <ul id="Nav" class="layui-nav layui-nav-tree">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="<?php echo url('index/vip/advert'); ?>">系统设置</a></dd>
                ...
                <li class="layui-nav-item">
                  ...
                  <dl class="layui-nav-child">
                        <dd><a href="<?php echo url('index/vip/apptc'); ?>">弹窗消息</a></dd>
                        <dd><a href="<?php echo url('index/vip/appts'); ?>">消息推送</a></dd>
                        <dd><a href="<?php echo url('index/vip/tspz'); ?>">推送配置</a></dd>
                    </dl>                    
                </li>
               ...
               <li class="layui-nav-item">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="<?php echo url('Km/kmprice'); ?>">提卡点数管理</a></dd>
                    </dl>
                </li>
              ...
              <?php }if(session('power')=='0' or session('power')=='1'){?>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="<?php echo url('index/common/epayview'); ?>">支付管理</a></dd>
                    </dl>
                  <dl class="layui-nav-child">
                        <dd><a href="http://pay.redlk.com/user/login.php">接口申请</a></dd>
                    </dl>
                </li>
                <?php }if(session('power')=='0' or session('power')=='1'){?>
                <li class="layui-nav-item">
              ...
              <?php }if(session('power')=='0'){?>          
                ...
                <li class="layui-nav-item">
                  ...
                  <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="http://959495.xyz/mp4/">影视站</a></dd>
                      <?php if(session('power')=='0'){?>
                        <dd><a href="http://959495.xyz/mp4/admin.php">影视站管理</a></dd>
                        <dd><a href="<?php echo url('vip/jxpost'); ?>">全网解析</a></dd>
                      <?php }?>
                    </dl>
                </li>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <?php if(session('power')=='0'){?>
                        <dd><a href="<?php echo url('Moneyorders/fzcx'); ?>">分站查询</a></dd>
                        <dd><a href="<?php echo url('Moneyorders/fzcx'); ?>">分站授权</a></dd>
                        <dd><a href="<?php echo url('vip/fenzhan'); ?>">分站列表</a></dd>
                        <?php } ?>
                  ...
                  <li class="layui-nav-item">
					...
					<dl class="layui-nav-child">
						...
						<dd>
							<a href="<?php echo url('vip/gx'); ?>">版本更新</a>
						</dd>
						<dd>
							<a href="http://tu.redleave.cn/">图片外链</a>
						</dd>
					</dl>
				</li>
