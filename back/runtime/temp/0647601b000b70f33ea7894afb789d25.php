<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"/www/wwwroot/959495.xyz/applications/index/view/video/add.html";i:1551816900;}*/ ?>
  ...
  <!--标题-->
       ...
       <div class="panel-heading">
               ...
               <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 热门电影添加
         </div>
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1"  method="post" action="<?php echo url('video/create'); ?>" enctype="multipart/form-data" class="validate">
