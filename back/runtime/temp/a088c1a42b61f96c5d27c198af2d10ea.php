<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/www/wwwroot/959495.xyz/applications/index/view/shangcheng/update.html";i:1551816900;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1"  method="post" action="<?php echo url('shangcheng/edit'); ?>" enctype="multipart/form-data" class="validate">
            ...
            <div class="form-group">
          	...
          	<div class="form-group">
                <label class="control-label">商品描述(可使用html代码)</label>
				<textarea class="form-control" name="miaoshu" cols="5" style="margin: 0px -33.5px 0px 0px; width: 100%; height: 350px;" aria-invalid="false"><?php echo $data['miaoshu']; ?></textarea>
            </div>
          
            <div class="form-group">
                <label class="control-label">商品价格</label>

                <input type="text" class="form-control" name="money" value="<?php echo $data['money']; ?>"  placeholder="" />
            </div>
            <div class="form-group">
