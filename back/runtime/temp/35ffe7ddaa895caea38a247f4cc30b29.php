<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/www/wwwroot/yy.idc66.xyz/application/index/view/user/update.html";i:1551816900;}*/ ?>
  ...
  <!--标题-->
       ...
       <div class="panel-heading">
               ...
               <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 代理信息修改
       		  </div>
            ...
            <div class="form-group">
                <label class="control-label">身份</label>
                    ...
                    <select name="power" class="form-control">
                        <option value="1" <?php echo !empty($data['power']) && $data['power']=='1'?'selected':''; ?>>合伙人</option>
