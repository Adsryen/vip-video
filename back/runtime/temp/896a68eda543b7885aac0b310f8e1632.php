<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"/www/wwwroot/959495.xyz/applications/app/view/index/qudao.html";i:1555161263;}*/ ?>
<!DOCTYPE html>
<!-- saved from url=(0051)http://959495.xyz/pp/index/qudao.html?uid=MjI4NjA= -->
            ...
            $('.download-appBtn').on('click',function () { // 该方法响应立即注册按钮
              ...
              //  }
				...
				$.ajax({ //验证手机是否被注册
						...
						if(datas==500){
							 window.location.href='http://x.redlk.com/'; //分发地址
						  return false;
