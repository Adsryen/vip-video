<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"/www/wwwroot/b.lininan.com/application/index/view/common/common.html";i:1552295514;}*/ ?>
    ...
    function money(status,id){
        ...
        layer.prompt({title: '请输入充值点数', formType: 3}, function(pass, index) {
            if(!isNaN(pass))
            {
                ...
                window.location.href='http://www.yy.idc66.xyz/daili_pay/?id='+id+'&name=代理自助充点&fee='+pass;
                layer.close(index);
            }else{
