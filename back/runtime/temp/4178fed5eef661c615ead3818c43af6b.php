<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/b.lininan.com/application/index/view/shangcheng/dingdan.html";i:1551816900;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
               ...
               <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 商品订单管理
                    </div>
    <!--标题-->
                    ...
                    <table cellspacing="0" class="table table-small-font table-bordered table-striped">
                        ...
                        <tr>
						    <th style="width: 120px">id</th>
                          	<th style="width: 180px">购买用户ID</th>
                            <th>订单号</th>
                            <th>购买价格</th>  
                            <th>商品ID</th>
                            <th>购买时间</th>                        
                        ...
                        <tr>
                          ...
                          <th>
                           ...
                           <th style=" text-align: center;">
                             <?php if($vo['type']==1){ ?>
                             <a href="<?php echo url('shangcheng/fahuo',['id'=>$vo['id']]); ?>" title="发货" > <i class="el-edit" style="font-size: 18px;color: #68b828"></i></a>
                             <?php }else{ ?>
								发货信息:<a style="color:red"><?php echo $vo['fahuoxinxi']; ?></a>
							 <?php }?>
                            </th> 
