<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/www/wwwroot/yy.idc66.xyz/application/index/view/tv/update.html";i:1551816900;}*/ ?>
...
<div class="panel panel-default">
  ...
  <!--标题-->
    ...
    <!--标题-->
       ...
       <img style="width: 10%; height:auto" src="<?php echo $data['img']; ?>">
    <div class="panel-body">

        <form role="form" id="form1"  method="post" action="<?php echo url('tv/edit'); ?>" enctype="multipart/form-data" class="validate">
            ...
            <div class="form-group">
                <label class="control-label">电视台标题</label>
