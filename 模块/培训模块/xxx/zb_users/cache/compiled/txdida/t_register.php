<?php  /* Template Name:注册页面模板 */  ?>
<?php  include $this->GetTemplate('header');  ?>

<div class="login-box">
    <div class="tx-box">
        <div class="data-box mb20">
            <h3 class="f-22 mb30 ta-c">欢迎加入<?php  echo $name;  ?>！</h3>
        ...
        <div class="tx-reg-side ta-c">
            <h3 class="f-14 mb10">如果你已经有<?php  echo $name;  ?>账号，请直接<a href="<?php  echo $host;  ?>?Login">点击登录</a></h3>
        </div>
