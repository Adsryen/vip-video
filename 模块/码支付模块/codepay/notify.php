...
{ //业务处理例子 返回一些字符串
    ...
    if ($rs && $stmt->affected_rows >= 1) { //插入成功 是首次通知 可以执行业务
        ...
        $x1 = "%**#".$price;
        if(strpos($x1,"0.5") > 0){         //if(strpos($x1,"1") > 0){ 中的"1" 为7天卡价格
        $x1 = "7" ;
        $x1 = $x1 * 86400 ;//1表示比率为1:1  100则表示1元可充值100分;
        $sql = "update `" . DB_USERTABLE . "` set " . DB_USERMONEY . "=" . DB_USERMONEY . "+{$x1} where " . DB_USERNAME . "=?";
        $fx1 = "1" ; //分销获得金额
        }
        else{
        if(strpos($x1,"2") > 0){         //if(strpos($x1,"1") > 0){ 中的"18" 为30天卡价格
        $x1 = "30" ;
        $x1 = $x1 * 86400 ;//1表示比率为1:1  100则表示1元可充值100分;
        $sql = "update `" . DB_USERTABLE . "` set " . DB_USERMONEY . "=" . DB_USERMONEY . "+{$x1} where " . DB_USERNAME . "=?";
        $fx1 = "1" ; //分销获得金额
        ...
        if(strpos($x1,"5") > 0){         //if(strpos($x1,"1") > 0){ 中的"18" 为90天卡价格
        $x1 = "90" ;
        $x1 = $x1 * 86400 ;//1表示比率为1:1  100则表示1元可充值100分;
        $sql = "update `" . DB_USERTABLE . "` set " . DB_USERMONEY . "=" . DB_USERMONEY . "+{$x1} where " . DB_USERNAME . "=?";
        $fx1 = "1" ; //分销获得金额
        ...
        if(strpos($x1,"10") > 0){         //if(strpos($x1,"1") > 0){ 中的"38" 为180天卡价格
        $x1 = "180" ;
        $x1 = $x1 * 86400 ;//1表示比率为1:1  100则表示1元可充值100分;
        $sql = "update `" . DB_USERTABLE . "` set " . DB_USERMONEY . "=" . DB_USERMONEY . "+{$x1} where " . DB_USERNAME . "=?";
        $fx1 = "1" ; //分销获得金额
        ...
        if(strpos($x1,"15") > 0){         //if(strpos($x1,"1") > 0){ 中的"48" 为360天卡价格
        $x1 = "360" ;
        $x1 = $x1 * 86400 ;//1表示比率为1:1  100则表示1元可充值100分;
        $sql = "update `" . DB_USERTABLE . "` set " . DB_USERMONEY . "=" . DB_USERMONEY . "+{$x1} where " . DB_USERNAME . "=?";
        $fx1 = "1" ; //分销获得金额
        ...
        if(strpos($x1,"30") > 0){         //if(strpos($x1,"1") > 0){ 中的"58" 为666天卡价格
        $x1 = "666" ;
        $x1 = $x1 * 86400 ;//1表示比率为1:1  100则表示1元可充值100分;
        $sql = "update `" . DB_USERTABLE . "` set " . DB_USERMONEY . "=" . DB_USERMONEY . "+{$x1} where " . DB_USERNAME . "=?";
        $fx1 = "1" ; //分销获得金额
        ...
        // $sql = "update `" . DB_USERTABLE . "` set " . DB_USERJE . "=" . DB_USERJE . "+{$x1} where " . DB_USERSJ . "=?";
            return 'ok'; //业务处理完成 。
