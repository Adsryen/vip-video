		...
		*/
		...
		function getData() {
			...
			if(localStorage.getItem('user_name') > 1) {
				...
				//				weichat.innerHTML = 'QQ号：' + user_weichat;
				...
				api.ajax({
					...
					if(ret) {
						...
						jifenbi = ret.sign;
						   bili.innerHTML = ret.sign+'积分可以兑换会员资格哦！';
						api.hideProgress();
...
原弹窗提示*/
         ...
         api.closeWin({
            ...
            api.openWin({
                 name: 'h5',
                 url: 'http://959495.xyz/index/index/index',
                });
*/
							api.openWin({
...
*/
							...
							api.openWin({
								...
								delay: 300,
								pageParam: {
									url: 'http://959495.xyz/index/dianka/index'
								},
								bgColor: 'rgba(0,0,0,0)'
							});
					...
					if(ret) {
						if(ret.code == 0) {
							...
							api.openWin({
								...
								delay: 300,
								pageParam: {
									url: 'http://959495.xyz/index/getmoney/tixian.html'
								},
								bgColor: 'rgba(0,0,0,0)'
							});
...
*/
							...
							api.openWin({
								...
								delay: 300,
								pageParam: {
									url: 'http://959495.xyz/index/user/pass'
								},
								bgColor: 'rgba(0,0,0,0)'
							});
      ...
      if (ret.code == 1) {
           api.toast({
              ...
              api.openWin({
                  ...
                  url: './daili_guanli_win.html',
                  delay: 100,
                  pageParam:{url:'http://959495.xyz/index/getmoney/tixian.html'},
                  bgColor: 'rgba(0,0,0,0)'
              });
         }else {
         api.hideProgress();
...
*/
					api.openWin({
						name: 'dailizhuanqu_win',
						url: './dailizhuanqu_win.html',
						delay: 300,
						pageParam: {
							url: 'http://959495.xyz/index/index/index'
						},
					...
					if(ret) {
						if(ret.code == 0) {
							...
							api.openWin({
								...
								delay: 300,
								pageParam: {
									url: 'http://959495.xyz/index/vip/index'
								},
								bgColor: 'rgba(0,0,0,0)'
							});
       ...
       /*       alert('登录成功');
             ...
             api.toast({
                ...
                api.openWin({
                    ...
                    url: './daili_guanli_win.html',
                    delay: 100,
                    pageParam:{url:'http://959495.xyz/index/user/index.html'},
                    bgColor: 'rgba(0,0,0,0)'
                });
